...
import 'screens/public_reports_screen.dart';
import 'screens/citizen/public_feed_screen.dart';
import 'screens/citizen/citizen_help_screen.dart';
import 'screens/citizen/admin_steps_screen.dart';
...
'/editProfile': (context) => EditProfileScreen(),
      ...
      //  '/editMoto': (context) => EditMotoScreen(moto: ModalRoute.of(context)!.settings.arguments),
       ...
       // '/publicReports': (context) => PublicReportsScreen(), // ✅
        // Citoyen invité
     // '/guestReport': (context) => GuestReportScreen(),
     // routes pour les public feed screen
     '/publicFeed': (context) => PublicFeedScreen(),   // ✅ nouvel écran
      '/citizenHelp': (context) => CitizenHelpScreen(),
    '/adminSteps': (context) => AdminStepsScreen(), 
