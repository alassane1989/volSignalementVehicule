...
class _CitizenHomeScreenState extends State<CitizenHomeScreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      //  automaticallyImplyLeading: true, // ✅ flèche retour si enfant
    ...
    return Padding(
      ...
      child: Row(
        ...
        children: [
          ...
          _statCard(Icons.timelapse, "En attente", pendingCount),
          _statCard(Icons.check_circle, "Validés", validatedCount),
        ],
      ),
    );
  }
