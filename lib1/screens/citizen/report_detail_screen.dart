  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: ListView(
        ...
        children: [
          // ✅ Plaque
          Text("Plaque : ${r.plaque}", style: TextStyle(fontSize: 20, fontWeight: FontWeight.bold)),
          SizedBox(height: 12),
          ...
          // ✅ Date formatée
          Text("Date du vol : $date", style: TextStyle(fontSize: 16)),
          SizedBox(height: 12),

          // ✅ Description (si tu l'as dans ton modèle)
